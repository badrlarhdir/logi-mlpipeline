...
class PackageBuilder:
    ...
    def __copy_requirements(self):
        """ Copy the requirements.txt file from the current directory to the directory 
    ...
    def __copy_data_folder(self):
        ...
        shutil.copytree('data', f'{PIPELINES_FOLDER}/{self.__subfolder}/data', 
                        dirs_exist_ok = True)
    ...
    def __copy_gitignore(self):
        ...
        shutil.copy(os.path.join(os.path.dirname(__file__), '.gitignore'), 
                    f'{PIPELINES_FOLDER}/{self.__subfolder}/.gitignore')
        # shutil.copy('./mlpipeline/mlpipeline/.gitignore', 
        #             f'{PIPELINES_FOLDER}/{self.__subfolder}/.gitignore')
    ...
    def copy_all(self, notebooks: list[str], subfolder: str = None ):
        ...
        for notebook in notebooks:
            print(notebook)
            # Copy the notebooks of the pipeline
            shutil.copy(notebook, f'{PIPELINES_FOLDER}/{self.__subfolder}/notebooks')
