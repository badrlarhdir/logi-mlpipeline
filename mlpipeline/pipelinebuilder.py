...
class PipelineBuilder:
    ...
    def set_notebooks(self, notebooks: list[str], subfolder: str = None):
        ...
        for notebook in notebooks:
            ...
            cells = list(filter(lambda cell: "pipeline." in cell.source, nb.cells))
    ...
    def set_pipeline_stage(self, stage: str, notebook_name: str, output_name: str, params: dict):
    ...
    def __save_pipeline(self, subfolder: str = None):
        ...
        def save_params():
            ...
            # Pipeline params
                ...
                wdir_params_yml = f'{PIPELINES_FOLDER}/{subfolder}/{wdir_params_yml}'
